...
app.directive('nglist', function () {
	return {
		restrict: 'E',
		templateUrl: 'app/lib/grid/grid.tmpl',
		controllerAs: 'myGrid',
...
app.directive('nglistHeader', function () {
	return {
		restrict: 'E',
		templateUrl: 'app/lib/grid/header.tmpl',
		controllerAs: 'myGrid',
		controller: function ($scope) {
		}
	};
...
app.directive('nglistFooter', function () {
	return {
		restrict: 'E',
		templateUrl: 'app/lib/grid/footer.tmpl',
		controllerAs: 'myGrid',
		controller: function ($scope) {
		}
	};
...
app.directive('nglistPagination', function () {
	return {
		restrict: 'E',
		templateUrl: 'app/lib/grid/pagination.tmpl',
		controllerAs: 'myGrid',
		controller: function ($scope) {
		}
	};
...
app.directive('nglistBody', function () {
	return {
		restrict: 'E',
		templateUrl: 'app/lib/grid/body.tmpl',
		controllerAs: 'myGrid',
		controller: function ($scope) {
		}
	};
